...
function syscall6(nr, a, b, c, d, e, f, callback) {
	return bindings.syscall(nr, a, b, c, d, e, f, callback);
}
...
module.exports = {
	...
	getdents64:   syscall2.bind(null, constants.SYS_getdents64),
	...
	pread64:      syscall3.bind(null, constants.SYS_pread64),
	pwrite64:     syscall3.bind(null, constants.SYS_pwrite64),
	read:         syscall2.bind(null, constants.SYS_read),
	...
	write:        syscall2.bind(null, constants.SYS_write)
};
